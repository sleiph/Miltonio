...
class tela_respostas : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun setCardsInativos(){
            card_resposta_1.setCardBackgroundColor(applicationContext.getColor(R.color.card_respostas))
            card_resposta_2.setCardBackgroundColor(applicationContext.getColor(R.color.card_respostas))
            card_resposta_3.setCardBackgroundColor(applicationContext.getColor(R.color.card_respostas))
            card_resposta_4.setCardBackgroundColor(applicationContext.getColor(R.color.card_respostas))
        }

        fun getPerguntas(index:Int) {
            txt_pergunta.text = arr_adm_perguntas[ordemPerguntas[index]][0]
            shuffle(ordemRespostas)
