...
class SisDist {
    val materia = Materia(
        ...
        mutableListOf(
            ...
            Pergunta(
                R.string.sem5_sdt_p2, 1,47,
                mutableListOf(
                    Resposta(R.string.sem5_sdt_p2r1, true, R.string.sem5_sdt_p2),
                    Resposta(R.string.sem5_sdt_p2r2, false, R.string.sem5_sdt_p2),
            ...
            Pergunta(
                R.string.sem5_sdt_p8, 1,47,
                mutableListOf(
                    Resposta(R.string.sem5_sdt_p8r1, true, R.string.sem5_sdt_p8),
                    Resposta(R.string.sem5_sdt_p8r2, false, R.string.sem5_sdt_p8),
                    Resposta(R.string.sem5_sdt_p8r3, false, R.string.sem5_sdt_p8),
                    Resposta(R.string.sem5_sdt_p8r4, false, R.string.sem5_sdt_p8)
                )
            ),
            Pergunta(
                R.string.sem5_sdt_p9, 1,47,
                mutableListOf(
                    Resposta(R.string.sem5_sdt_p9r1, true, R.string.sem5_sdt_p9),
                    Resposta(R.string.sem5_sdt_p9r2, false, R.string.sem5_sdt_p9),
                    Resposta(R.string.sem5_sdt_p9r3, false, R.string.sem5_sdt_p9)
                )
            ),
            Pergunta(
                R.string.sem5_sdt_p10, 1,47,
                mutableListOf(
                    Resposta(R.string.sem5_sdt_p10r1, true, R.string.sem5_sdt_p10),
            ...
            Pergunta(
                R.string.sem5_sdt_p12, 1,47,
                mutableListOf(
                    Resposta(R.string.sem5_sdt_p12r1, true, R.string.sem5_sdt_p12),
                    Resposta(R.string.sem5_sdt_p12r2, false, R.string.sem5_sdt_p12),
                    Resposta(R.string.sem5_sdt_p12r3, false, R.string.sem5_sdt_p12),
                    Resposta(R.string.sem5_sdt_p12r4, false, R.string.sem5_sdt_p12)
                )
            )
        )
    )
